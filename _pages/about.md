...
My current Servant Class is **Framer X Saber (Mathematics->Excalibur)** based on the calling: to bravely build up the theoretical/computational **frame**work for the research topics within applied science with the help of mathematics. Besides, I would like to be an **Umbreller**, to hold the **umbrella** for the needed people.
...
My interests could be summarized as the spanned space of {"disorder", "Representations", "Transport", and "Stability"}, I would like to explain more in future statements. Some of my current projects involve heat transport, neutron magnetic scattering, XPCS, and physical metallurgy.
